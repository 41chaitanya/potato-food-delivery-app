package com.microServiceTut.restaurant_service.config;
...
public class RedisConfig {
    ...
    private static final Duration RESTAURANT_CACHE_TTL = Duration.ofMinutes(10);
